...
-- Этот запрос выберет заглавие и тип книги (книга о войне, книга о мире или другая книга) в зависимости от содержания заглавия (поисковый оператор CASE).
...
-- Этот запрос создаст встроенное представление Новые_книги, выберет заглавие и год издания всех книг, выпущенных после 2020 года, и выведет результат.
...
-- Этот запрос выбирает названия издательств и количество изданий, которые они выпустили, и ограничивает результаты только теми издательствами, которые выпустили более пяти книг.
...
-- Этот запрос выбирает имена читателей и количество книг, которые они взяли в библиотеке, и ограничивает результаты только теми, кто взял книги, выпущенные после среднего года издания всех книг в библиотеке.
...
-- Этот запрос позволяет посчитать количество изданий по каждому издательству и типу издания с использованием функции ROLLUP, которая добавляет дополнительные строки для общих итогов.
